...
var style_519611968Reubicado_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_519611968Reubicado_3_eval_expression(context) !== null) {
        labelText = String(exp_label_519611968Reubicado_3_eval_expression(context));
    }
