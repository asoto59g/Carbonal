...
function exp_label_519611968Reubicado_3_eval_expression(context) {
    // 'Area= ' || AreaHa || ' Ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return (('Area= ' + feature.get('AreaHa') ) + ' Ha');
    } else {
        return (('Area= ' + feature.get('AreaHa') ) + ' Ha');
    }
}
...
function exp_label_519611968Original_4_eval_expression(context) {
    // 'Area= ' || Area || ' Ha'
